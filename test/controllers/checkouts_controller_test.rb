...
class CheckoutsControllerTest < ActionController::TestCase
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post :create, checkout: { bike_id: @checkout.bike_id, returned_at: @checkout.returned_at, user_id: @checkout.user_id }
    end
  ...
  test "should update checkout" do
    patch :update, id: @checkout, checkout: { bike_id: @checkout.bike_id, returned_at: @checkout.returned_at, user_id: @checkout.user_id }
    assert_redirected_to checkout_path(assigns(:checkout))
  end
